...
function handle_AnimateNumber() {
            
    if ($().animateNumber) {
        $(".num-animater").each(function () {
            $(this).animateNumber({
               number: $(this).text(),
               easing: 'easeInQuad'
            }, $(this).data('delay') );
...
function handle_RateYo() {
            
    if ($().rateYo) {
        $(".ele-rateYo").each(function () {
            $(this).rateYo({
                rating: $(this).attr("data-rating"),
                starWidth: $(this).attr("data-starWidth"),
                normalFill: $(this).attr("data-normalFill"),
                ratedFill: $(this).attr("data-ratedFill"),
                numStars: $(this).attr("data-numStars"),
                halfStar: ($(this).attr("data-halfStar") == "1" ? true : false),
                readOnly: ($(this).attr("data-readOnly") == "1" ? true : false),
                multiColor: {
                    "startColor": $(this).attr("data-startColor"),
                    "endColor": $(this).attr("data-endColor")
                }
            });
        });
    }
